  ...
  graphTypeDetails: {
    ...
    'directed': {
      ...
      svg: `
        <svg width="340" height="180" viewBox="0 0 340 180">
          <defs>
            <marker id="m-dir" viewBox="0 0 10 10" refX="7" refY="5" markerWidth="6" markerHeight="6" orient="auto">
              <path d="M 0 1.5 L 9 5 L 0 8.5 Z" fill="#06b6d4" />
            </marker>
          </defs>
          <line x1="93" y1="78.5" x2="145" y2="52.5" stroke="#06b6d4" stroke-width="3.5" marker-end="url(#m-dir)"/>
          <line x1="195" y1="52.5" x2="247" y2="78.5" stroke="#06b6d4" stroke-width="3.5" marker-end="url(#m-dir)"/>
          <line x1="242" y1="90" x2="98" y2="90" stroke="#06b6d4" stroke-width="3.5" marker-end="url(#m-dir)"/>
    ...
    'cyclic': {
      ...
      svg: `
        <svg width="340" height="180" viewBox="0 0 340 180">
          <defs>
            <marker id="m-cyc" viewBox="0 0 10 10" refX="7" refY="5" markerWidth="6" markerHeight="6" orient="auto">
              <path d="M 0 1.5 L 9 5 L 0 8.5 Z" fill="#ef4444" />
            </marker>
          </defs>
          <line x1="93" y1="78.5" x2="145" y2="52.5" stroke="#ef4444" stroke-width="3.5" marker-end="url(#m-cyc)"/>
          <line x1="195" y1="52.5" x2="247" y2="78.5" stroke="#ef4444" stroke-width="3.5" marker-end="url(#m-cyc)"/>
          <line x1="242" y1="90" x2="98" y2="90" stroke="#ef4444" stroke-width="3.5" marker-end="url(#m-cyc)"/>
    ...
    'dag': {
      ...
      svg: `
        <svg width="340" height="180" viewBox="0 0 340 180">
          <defs>
            <marker id="m-dag" viewBox="0 0 10 10" refX="7" refY="5" markerWidth="6" markerHeight="6" orient="auto">
              <path d="M 0 1.5 L 9 5 L 0 8.5 Z" fill="#10b981" />
            </marker>
          </defs>
          <line x1="83" y1="80" x2="145" y2="51" stroke="#10b981" stroke-width="3.5" marker-end="url(#m-dag)"/>
          <line x1="83" y1="100" x2="145" y2="129" stroke="#10b981" stroke-width="3.5" marker-end="url(#m-dag)"/>
          <line x1="195" y1="50" x2="255" y2="69" stroke="#10b981" stroke-width="3.5" marker-end="url(#m-dag)"/>
          <line x1="195" y1="130" x2="255" y2="111" stroke="#10b981" stroke-width="3.5" marker-end="url(#m-dag)"/>
